...
public final class RendererCapabilityState {
    ...
    public static RendererCapabilityState probe() {
        ...
        try {
            ...
            HeliumClient.LOGGER.error("[Rentities] Capability probe failed; using safe fallback", t);
        }
        return s;
    }
    ...
    public boolean indirectAllowed(HeliumConfig cfg) {
        return cfg != null && cfg.entityGpuFrustumCulling && indirect && indirectHealthy && gpuBatchingHealthy;
    }
    ...
    public void markFailed(Feature feature, Throwable error) {
        ...
        HeliumClient.LOGGER.error("[Rentities] Disabled feature {} for safety: {}", feature, reason, error);
    }
