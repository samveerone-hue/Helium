...
public final class EntityBatchRegistry {
    ...
    private static final java.util.concurrent.atomic.AtomicInteger NEXT_TYPE_INDEX =
            new java.util.concurrent.atomic.AtomicInteger(0);

    public static int getEntityTypeIndex(EntityType<?> type) {
        if (type == null) return 0;
        return TYPE_INDEX_MAP.computeIfAbsent(type, t -> NEXT_TYPE_INDEX.getAndIncrement());
    }
