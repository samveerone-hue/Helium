...
public class HeliumConfig {
    ...
    public String renderingsnapshot() {
        return entityCulling + "," + entityCullDistance + "," + blockEntityCulling + "," + blockEntityCullDistance + "," + particleCulling + "," + particleCullDistance + "," + particleLimiting + "," + maxParticles + "," + particlePriority + "," + particleBatching + "," + animationThrottling + "," + fastMath + "," + glStateCache + "," + fastAnimations + "," + cachedEnumValues + "," + modelCache + "," + modelCacheMaxMb + "," + leafCullingMode + "," + leafCullingDepth + "," + leafCullingMangroveRoots + "," + signTextCulling + "," + rainCulling + "," + beaconBeamCulling + "," + paintingCulling + "," + itemFrameCulling + "," + itemFrameLOD + "," + itemFrameLODRange + "," + renderPipelining + "," + adaptiveChunkScheduling + "," + chunkScheduleMaxPerTick + "," + particleLOD + "," + particleLODDistance + "," + particleLODReduction + "," + fastFramebufferBlit + "," + poseStackPooling + "," + fastBambooLight + "," + optimizedLightEngine + "," + fullbright;
    }
    ...
    public static HeliumConfig importFromFile(Path path) {
        if (!Files.exists(path)) { HeliumClient.LOGGER.warn("import file does not exist: {}", path); return null; }
        try {
