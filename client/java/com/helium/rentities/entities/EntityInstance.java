...
public final class EntityInstance {
    ...
    /** Armor Stand state retains its original dedicated bit. */
    public static final int FLAG_ARMOR_STAND = 512;
    /** Exact Minecraft model pose; kept separate from Armor Stand state. */
    public static final int FLAG_EXACT_MODEL_POSE = 4096;
